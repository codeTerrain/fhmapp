...
class NationalRepChat extends StatefulWidget {
  final String category;
  final String chatUserId;
  final Users currentUser;
  const NationalRepChat(
      {Key? key,
  ...
  @override
  State<NationalRepChat> createState() => _NationalRepChatState();
}

class _NationalRepChatState extends State<NationalRepChat> {
  ...
  void initState() {
    ...
    chatRoomId = getChatRoomId(widget.chatUserId, widget.category);
    super.initState();
  }
